...
.then(function(data){
    ...
    document.getElementById("Monday-temp").textContent = `Temperature: ${day1Temp}`;
    document.getElementById("Teusday").textContent = `Tuesday: ${day2Temp}`;
    document.getElementById("Wednesday").textContent = `Wednesday: ${day3Temp}`;
    document.getElementById("Thursday").textContent = `Thursday: ${day4Temp}`;
    document.getElementById("Friday").textContent = `Friday: ${day5Temp}`;
